...
export function ClienteDetail() {
  ...
  const fields: { id: string; label: string; value: string | null }[] = [
    ...
    { id: "gclick", label: "G-click", value: client.gclick ? "CADASTRADO" : null },
    { id: "dominio", label: "Domínio", value: client.dominio ? "CADASTRADO" : null },
    { id: "xmlSaida", label: "XML Saída", value: client.xmlSaida },
    { id: "email", label: "E-mail (Primário)", value: client.email },
    { id: "email2", label: "E-mail (Secundário)", value: client.email2 },
    { id: "telefone", label: "Telefone (Primário)", value: client.telefone },
    { id: "contato", label: "Contato", value: client.contato },
    { id: "telefone2", label: "Telefone (Secundário)", value: client.telefone2 },
    { id: "contato2", label: "Contato", value: client.contato2 },
